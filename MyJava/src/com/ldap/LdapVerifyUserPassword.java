...
public class LdapVerifyUserPassword {
	 ...
	 * args example
	 * 
	 * sun zzzB140081@adtest.cuhk.edu.hk abcd123$
	 * central DDB103773@cuhk.edu.hk 7hh5v8?#
	 * 
	 * */
	public static void main(String[] args)
	{
		String ldapSettingSet = "central";
		String searchKeyword = "";
		String ldapUsername="DDB103773@cuhk.edu.hk", ldapPassword="7hh5v8?#";
/*		
		DDA313700	wbsem8.$
		DDA315700	yznvg6?.
		DDB103770	x98vr7$$
...
*/
		...
		if(args.length>0)
		{
			...
			if(args[1]!=null)
			{
				ldapUsername = args[1].trim();
			}
			if(args[2]!=null)
			{
				ldapPassword = args[2].trim();
			}
		}
		
		new LdapVerifyUserPassword( ldapSettingSet, ldapUsername, ldapPassword );
	}
	
	public LdapVerifyUserPassword(String ldapSettingSet,  
	...
	public static void listResultCsv(NamingEnumeration<SearchResult> results, String ldapSettingSet) throws NamingException, IOException
	{
